...
- 1.0.31：<https://github.com/ShiFeng546/zhi-yu/releases/download/v1.0.31/zhiyu-1.0.31-release.apk>
- 安装包 SHA-256：`3b950339341527b6080b43dc1ac4bfc825b5f0d6e992e9d3b33d19626e5cfb50`
- 版本清单：仓库根目录的 `update.json`，也可读 `https://api.github.com/repos/ShiFeng546/zhi-yu/releases/latest`

真机如果已经装过 debug 签名的同名包，需要先卸载再装正式包。两套签名不能互相覆盖。已安装 1.0.0 ~ 1.0.30 正式包可直接覆盖。
