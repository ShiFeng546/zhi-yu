...
- 1.0.32：<https://github.com/ShiFeng546/zhi-yu/releases/download/v1.0.32/zhiyu-1.0.32-release.apk>
- 安装包 SHA-256：`748d404609613d2c6216c429558fe2cf3ca6a9c97795ff3500b416d60f4a8b23`
- 版本清单：仓库根目录的 `update.json`，也可读 `https://api.github.com/repos/ShiFeng546/zhi-yu/releases/latest`

真机如果已经装过 debug 签名的同名包，需要先卸载再装正式包。两套签名不能互相覆盖。已安装 1.0.0 ~ 1.0.31 正式包可直接覆盖。
